...
**Purpose:** Enable automatic context assembly via dependency graph. Frontmatter makes summary metadata machine-readable so phase-plan can scan all summaries quickly and select relevant ones based on dependencies.
